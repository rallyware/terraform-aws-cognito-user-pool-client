...
| <a name="input_access_token_validity"></a> [access\_token\_validity](#input\_access\_token\_validity) | Time unit in for the value in access\_token\_validity, defaults to hours | `number` | `1` | no |
...
| <a name="input_id_token_validity"></a> [id\_token\_validity](#input\_id\_token\_validity) | Time unit in for the value in id\_token\_validity, defaults to hours. | `number` | `1` | no |
...
| <a name="input_refresh_token_validity"></a> [refresh\_token\_validity](#input\_refresh\_token\_validity) | Time unit in for the value in refresh\_token\_validity, defaults to days | `number` | `1` | no |
